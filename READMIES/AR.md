...
يسجل Click Repeater النقرات على صفحة ويب ويكررها لاحقًا.

سجّل النقرات مرة واحدة، واضبط طريقة تشغيلها، ثم شغّلها من نافذة الإضافة أو باستخدام اختصار لوحة المفاتيح. يمكن للنقرات استخدام الإحداثيات المسجلة أو عناصر الصفحة.
